...
mod tests {
  ...
  use crate::types::u256::tests::hex_to_bytes;
    ...
    let cases: [(&[u8], &str); 8] = [
      ...
      (b"\0abc", "1ZiCa"),
      (b"\0\0abc", "11ZiCa"),
      (&hex_to_bytes("00bd8813e79baa5fa1874ca8b70877d1b044e220ecd34a60eca3ba15fc36b378e7").unwrap(), "1DkrQMni2h8KYpvY8t7dECshL66gwnxiR5uD2Udxps6og"),
      (&hex_to_bytes("001dd2aa371711d1faea1c96d395f08eb94de1f388993e8be3f4609dc327ab513a").unwrap(), "131R8ufDhcsu6SRztR9D3m8GUzkWFUPfT78aQ6jgtgzob"),
      (&hex_to_bytes("02798e9e137aec7c2d59d9655b4ffa640f301f628bf7c365083bb255f6aa5f89ef").unwrap(), "je9CrJD444xMSGDA2yr1XMvugoHuTc6pfYEaPYrKLuYa"),
      (&hex_to_bytes("02e5d64f886664c58378d41fe3b8c29dd7975da59245a4a6bf92c3a47339a9a0a9").unwrap(), "rvpeCy7GhsGHq8n6TnB1LjQh4xn1FMHJVXnsdZAniKZA"),
    ];
